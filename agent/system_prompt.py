...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Kanban worker lifecycle guidance is populated at initialization only
    # for a dispatcher-assigned task. A profile-level kanban toolset alone
    # does not make a standalone session a worker.
