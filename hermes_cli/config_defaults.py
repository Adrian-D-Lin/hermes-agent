...
DEFAULT_CONFIG = {
    ...
    "kanban": {
        # Mutation authority and its machine-global database identity. Native
        # remains the inactive/backward-compatible default; selecting the
        # Initiative Tracker without an absolute path fails closed.
