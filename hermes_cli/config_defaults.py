...
DEFAULT_CONFIG = {
    ...
    "kanban": {
        ...
        # Disabled by default: triage tasks remain pending until the
        # orchestrator or an authenticated dashboard user handles them.
        # Set true to opt into gateway-driven decomposition on every
        # dispatcher tick.
